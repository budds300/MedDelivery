...
$sql = $conn -> query("SELECT *FROM DOCTOR WHERE USERNAME='$username'");
if($sql->num_rows>0){
    $row=$sql->fetch_assoc();
}
?>
              ...
              <div class="card-footer bg-white">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-10">
                        ...
                        <input type="hidden" class="py-1 input-field" name="outgoing_id" placeholder="" value="<?php echo $_SESSION['login_user2'];?>">
