...
<div class="container">
    ...
    <div class="offcanvas-body">
      <div class="list-group list-group-flush pt-5">
        ...
        <a href="delete_meds_items.php" class="list-group-item active btn-primary ">Delete Medicine Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_meds_items1.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> DELETE YOUR MEDICINE ITEMS FROM HERE </h3>
...
$sql = "SELECT * FROM drugs d WHERE d.options = 'ENABLE' AND d.S_ID IN (SELECT s.S_ID FROM stores s WHERE s.M_ID='$user_check') ORDER BY D_ID";
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <tbody>
    <tr>
      <td> <input name="checkbox[]" type="checkbox" value="<?php echo $row['D_ID']; ?>"/> </td>
