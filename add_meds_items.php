...
<div class="container">
    ...
    <div class="offcanvas-body">
      <div class="list-group list-group-flush pt-5">
        ...
        <a href="add_meds_items.php" class="list-group-item active  btn-primary ">Add Medicine Items</a>
    ...
    <div class="col-xs-9 ">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="add_meds_items1.php" method="POST" enctype="multipart/form-data">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> ADD NEW MEDICINE HERE </h3>
    
          <div class="form-group">
            <input type="text" class="form-control" id="name" name="name" placeholder="Your Medicine name" required="">
          </div>     
    
          <div class="form-group">
            <input type="text" class="form-control" id="price" name="price" placeholder="Your Medicine Price (KES)" required="">
          </div>
    
          <div class="form-group">
            <input type="text" class="form-control" id="description" name="description" placeholder="Your Mediction Description" required="">
          </div>
    
          <div class="form-group">
            <input type="file" class="form-control" id="image-path" name="image" placeholder="Your Medicine Image Path [images/<filename>.<extention>]" required="">
          </div>
