   ...
   <p>Get started by creating your account</p>
    ...
    <div class="row">
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="doctor_registered_success.php" method="POST">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="password"><span class="text-danger" style="margin-right: 5px;">*</span> Profession: </label>
            <div class="input-group">
              <input class="form-control" id="password" type="text" name="profession" placeholder="Profession" required="">
              <span class="input-group-btn">
