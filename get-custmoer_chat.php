...
$message =$conn->real_escape_string($_POST['message']);
    ...
    $sql=$conn->query("SELECT*FROM message  WHERE incoming_id='$incoming_id ' AND outgoing_id='$outgoing_id' OR incoming_id='$outgoing_id' AND outgoing_id='$incoming_id' order by id asc") or die();
    if($sql->num_rows>0){
